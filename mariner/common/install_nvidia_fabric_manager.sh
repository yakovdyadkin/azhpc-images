...
nvidia_fabricmanager_download_url=http://developer.download.nvidia.com/compute/cuda/repos/$nvidia_fabricmanager_distribution/x86_64/nvidia-fabric-manager-$nvidia_fabricmanager_version.x86_64.rpm
$COMMON_DIR/download_and_verify.sh $nvidia_fabricmanager_download_url $nvidia_fabricmanager_sha256
dnf install -y ./nvidia-fabric-manager-$nvidia_fabricmanager_version.x86_64.rpm
